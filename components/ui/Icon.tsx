// Inline Lucide-style SVG icon set, 1.8px stroke.
const PATHS: Record<string, string> = {
  ...
  note: '<path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8z"/><path d="M16 3v5h5"/>',
...
export function Icon({ name, size = 18, stroke = 'currentColor', strokeWidth = 1.8, className, style }: IconProps) {
