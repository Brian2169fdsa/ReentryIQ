// po-icons.jsx — minimal inline line-icon set (Lucide path data, 1.8px stroke).
function Icon({ name, size = 18, stroke = 'currentColor', sw = 1.8, style }) {
  const p = PO_ICONS[name] || '';
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
         stroke={stroke} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round"
         style={{ flexShrink: 0, ...style }} dangerouslySetInnerHTML={{ __html: p }} />
  );
}
...
Object.assign(window, { Icon, PO_ICONS });
